...
const Erreur = document.querySelector("#msg-error")
const Erreur2 = document.querySelector("#msg-error2")
const Erreur3 = document.querySelector("#msg-error3")
const Erreur4 = document.querySelector("#msg-error4")
let isValid = true 
